...
The goal of my application was to create a functioning web application that could serve as a place to keep track of one's favorite artists. It allows users to create and log in to accounts, as well as add, update, and delete artist data from the site. 
